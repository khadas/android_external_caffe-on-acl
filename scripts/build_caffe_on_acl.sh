...
N_JOBS=${N_JOBS:-12}
CAFFE_NAME=CaffeOnACL
CAFFE_ROOT=${WD}/$CAFFE_NAME
BUILD_DIR=${CAFFE_ROOT}/build/

ANDROID_LIB_ROOT=${WD}/prebuilts
...
cmake -DCMAKE_TOOLCHAIN_FILE="${WD}/android-cmake/android.toolchain.cmake" \
      ...
      -DCMAKE_INSTALL_PREFIX="${ANDROID_LIB_ROOT}/$CAFFE_NAME" \
      ..

make -j${N_JOBS}
rm -rf "${ANDROID_LIB_ROOT}/$CAFFE_NAME"
make install/strip
