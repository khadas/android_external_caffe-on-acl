...
find_library(ACL_GRAPH_LIBRARIES NAMES arm_compute_graph-static PATHS ${ACL_LIB_PATHS})
find_library(OPENCL_LIBRARIES NAMES OpenCL PATHS ${ACL_LIB_PATHS})
SET(ACL_LIBRARIES "${ACL_LIBRARIES} ${ACL_CORE_LIBRARIES} ${ACL_GRAPH_LIBRARIES} ${OPENCL_LIBRARIES}")
